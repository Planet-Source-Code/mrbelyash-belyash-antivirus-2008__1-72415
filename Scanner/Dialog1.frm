...
'позже заменить на API функцию,т.к. хуйня это а не проверка
    MsgBox "Приложение уже запущено", vbCritical
    End
End If
modScanVirus.selfTesting
abortprov = False
'Call regPrilog 'зарегестрировано ли
'ProcCount = 0
'procCountSpl = 0
'procFoundSpl = 0
'procCleanSpl = 0
...
modScanVirus.LogPrint "Запуск программы "

   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.CheckBox Check5 
            Caption         =   "Мониторить свой каталог"
            Height          =   315
            Left            =   120
            TabIndex        =   6
            Top             =   720
      ...
      Begin VB.Frame Frame2 
         ...
         Begin monitor.xpradiobutton Option2 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Caption         =   "Добавлять(ограничить )                Мб"
         End
      ...
      Begin VB.Frame Frame1 
         ...
         Begin monitor.xpcheckbox ldMonik 
            ...
            EndProperty
            Value           =   1
            Caption         =   "Запоминать состояние мониторинга"
         End
         Begin monitor.xpcheckbox Check3 
            ...
            EndProperty
            Value           =   1
            Caption         =   "Переместить в карантин"
         End
         Begin monitor.xpcheckbox lbAuto 
            ...
            EndProperty
            Value           =   1
            Caption         =   "Автозагрузка программы"
         End
         Begin monitor.xpcheckbox lbFon 
            ...
            EndProperty
            Value           =   1
            Caption         =   "Загрузка в фоновом режиме"
         End
      End
...
If Text2.Text > 12 Or Text2.Text <= 0 Then
    MsgBox "Превышение максимально допустимого размера файла лога", vbCritical, pr
    Text2.Text = "12"

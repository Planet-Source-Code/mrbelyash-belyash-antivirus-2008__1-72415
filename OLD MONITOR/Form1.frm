  ...
  'then there was a change in the folder.
   ...
   DoEvents
      ...
      'folder and indicate a change took place.
       WatchChangeAction watchPath
                            frmTest.Text1.Text = "Обнаружено изменение в каталоге программы.Продолжаю наблюдение..."
       ...
       DoEvents
         ...
         If watchStatus = -1 Then
              'watchStatus must have exited with the terminate flag
                           frmTest.Text1.Text = " Наблюдение за " & vbCrLf + watchPath + vbCrLf + "прервано"
                          Call frmTest.message
               'MsgBox "Watching has been terminated for " & watchPath
         
         Else: WatchChangeAction watchPath
               
               frmTest.Text1.Text = "Снова обнаружено изменение в каталоге с программой."
                          Call frmTest.message
                          'Exit Do
                          DoEvents
   ...
   Else
     'watchStatus must have exited with the terminate flag
      frmTest.Text1.Text = "Наблюдение за" & watchPath + " прервано"
                          Call frmTest.message
      'MsgBox "Watching has been terminated for " & watchPath

...
If hostname = "" Then
StatusBar.Panels(2).Text = "Не могу достучаться до хоста"
Exit Sub
End If
...
StatusBar.Panels(2).Text = "Убит процесс: " & Right(Connection(ListView1.SelectedItem.Tag).FileName, Len(Connection(ListView1.SelectedItem.Tag).FileName) - InStrRev(Connection(ListView1.SelectedItem.Tag).FileName, "\"))
Else
StatusBar.Panels(2).Text = "Ошибка терминирования: " & Right(Connection(ListView1.SelectedItem.Tag).FileName, Len(Connection(ListView1.SelectedItem.Tag).FileName) - InStrRev(Connection(ListView1.SelectedItem.Tag).FileName, "\"))
End If
End Sub
...
StatusBar.Panels(3).Text = "Отключен от сети"
Exit Sub
Else
StatusBar.Panels(3).Text = "В сети"
End If

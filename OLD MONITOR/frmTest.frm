...
Begin VB.Form frmTest 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Label Label8 
         BackColor       =   &H80000009&
         Caption         =   "Êîëè÷åñòâî àêòèâíûõ ïðîöåññîâ"
         Height          =   255
         Left            =   150
         TabIndex        =   20
         Top             =   1818
      ...
      Begin VB.Label Label2 
         BackColor       =   &H80000004&
         Caption         =   "Êîëè÷åñòâî èíôèöèðîâàííûõ:"
         Height          =   255
         Left            =   150
         TabIndex        =   16
         Top             =   2256
      ...
      Begin VB.Label Label3 
         BackColor       =   &H80000009&
         Caption         =   "Êîëè÷åñòâî çàáëîêèðîâàííûõ"
         Height          =   255
         Left            =   150
         TabIndex        =   15
         Top             =   2694
      ...
      Begin VB.Label Label5 
         BackColor       =   &H80000009&
         Caption         =   "Êîëè÷åñòâî ïåðåìåùåííûõ"
         Height          =   255
         Left            =   150
         TabIndex        =   12
         Top             =   3132
      ...
      Begin VB.Label Label7 
         BackColor       =   &H80000009&
         Caption         =   "Êîëè÷åñòâî âèðóñîâ â áàçå"
         Height          =   255
         Left            =   150
         TabIndex        =   10
         Top             =   3900
      ...
      Begin VB.Label Label9 
         BackColor       =   &H80000009&
         Caption         =   "Äàòà ïîñëåäíåãî îáíîâëåíèÿ"
         Height          =   255
         Left            =   150
         TabIndex        =   8
         Top             =   4290
      ...
      Begin VB.Label Label4 
         BackColor       =   &H80000009&
         Caption         =   "Êîëè÷åñòâî ïðîâåðåííûõ"
         Height          =   255
         Left            =   150
         TabIndex        =   6
         Top             =   1380
...
DoEvents
  ...
  If Left(lstBox.List(i), 1) <> "\" Then
      ...
      Debug.Print "ïðîöåññû" + lstBox.List(i)
             'ResumeThreads (hNumrer1)
            'Exit Sub
       End If
...
If App.PrevInstance = True Then
    MsgBox "Îäíàÿ êîïèÿ ïðîãðàììû óæå çàïóøåíà.Åñëè â òðåå íå ïîÿâèòñÿ çíà÷åê, òî ïåðåçàãðóçèòå îïåðàöèîííóþ ñèñòåìó Âèíäîâñ", vbCritical, pr
    End
End If
SystemInformation 'ïðîâåðÿåì XP ýòî èëè íåò
Call checkReestr12
Dim fn As Long
...
'÷èòàåì ïðåäûäóùåå ñîñòîÿíèå ìîíèòîðèíãà
   noList = False
    tmrON = False
    keyOn = 0
    monitorOn = False
...
If l3.Caption = "Âêëþ÷èòü" Then
    LogPrint "Âêëþ÷èëè ìîíèòîðèíã"
    frmTest.Text1.Text = ""
           Command1.Caption = "Âûêëþ÷èòü"
                   lblMonme.ForeColor = &HFF0000
           'Command1.Refresh
        l3.Caption = "Âûêëþ÷èòü"
    monitoring = True
        lblMonme.Caption = "Ìîíèòîð âêëþ÷åí"
             monitorOn = True
             Check_activitiproc
             frmTest.Text1.Text = ""
...
Else
    LogPrint "Âûêëþ÷èëè ìîíèòîðèíã"
     l3.Caption = "Âêëþ÷èòü"
          lblMonme.ForeColor = &HFF&
          monitoring = False
             lblMonme.Caption = "Ìîíèòîð âûêëþ÷åí"
        Command1.Caption = "Âêëþ÷èòü"
        'Command1.Refresh
...
'çàïîìèíàåì ñîñòîÿíèå ìîíèòîðèíãà äëÿ ñëåäóþùåãî çàïóñêà
...
GoTo 2
Case Else
MsgBox "Ïðîãðàììà êîððåêòíî ðàáîòàåò òîëüêî ïîä Windows XP" + vbCrLf + CStr(verinfo.dwPlatformId), vbExclamation, "Âíèìàíèå"
End
End Select

...
Begin VB.Form cmdAllow 
   ...
   Begin AppBlock.xpcmdbutton cmdPAllow 
      ...
      Left            =   120
      TabIndex        =   4
      ToolTipText     =   "Данное прилоение будет всегда без проверки запущено"
      Top             =   2220
      Width           =   1995
      _ExtentX        =   3519
      _ExtentY        =   661
      Caption         =   "Всегда разрешать"
   ...
   Begin AppBlock.xpcmdbutton cmdAllow 
      ...
      Left            =   2220
      TabIndex        =   5
      ToolTipText     =   "Что-то не понятно?"
      Top             =   2220
      Width           =   1995
      _ExtentX        =   3519
      _ExtentY        =   661
      Caption         =   "Пропустить единожды"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   204
   ...
   Begin AppBlock.xpcmdbutton cmdDeny 
      ...
      Left            =   4350
      TabIndex        =   6
      ToolTipText     =   "Сейчас заюлокировать,а в следующий раз снова спросить"
      Top             =   2220
      Width           =   2205
      _ExtentX        =   3889
      _ExtentY        =   661
      Caption         =   "Единожды заблокировать"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   204
   ...
   Begin AppBlock.xpcmdbutton cmdPDeny 
      ...
      Left            =   6750
      TabIndex        =   7
      ToolTipText     =   "понятно?См.справку"
      Top             =   2220
      Width           =   1995
      _ExtentX        =   3519
      _ExtentY        =   661
      Caption         =   "Навсегда забл."
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   204
...
Private Sub Form_Load()
    ...
    If Val(ReadRegShell("HKCU\Software\BGAntivirus\ControlAll")) = 1 Then
        ...
        For i = 1 To bCount
            ...
            If Command$ = ReadRegShell("HKEY_CURRENT_USER\Software\BGAntivirus\Ban\" & CStr(i)) Then
                'Call cmdDeny_Click
                Me.lblStatus.Caption = "Приложение заблокировано"
    ...
    Else
        ...
        If Me.lblStatus.Caption <> "Приложение заблокировано" Then

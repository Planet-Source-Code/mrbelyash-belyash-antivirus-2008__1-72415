...
Begin VB.UserControl xpradiobutton 
   ...
   Begin VB.Image img 
      ...
      Index           =   6
      Left            =   600
      Picture         =   "xpradiobutton.ctx":0376
      Top             =   1080
      Visible         =   0   'False
      Width           =   195
   End
   Begin VB.Image img 
      ...
      Index           =   5
      Left            =   360
      Picture         =   "xpradiobutton.ctx":04DE
      Top             =   1080
      Visible         =   0   'False
      Width           =   195
   End
   Begin VB.Image img 
      ...
      Index           =   4
      Left            =   120
      Picture         =   "xpradiobutton.ctx":071D
      Top             =   1080
      Visible         =   0   'False
      Width           =   195
   End
   Begin VB.Image img 
      ...
      Index           =   3
      Left            =   840
      Picture         =   "xpradiobutton.ctx":088A
      Top             =   840
      Visible         =   0   'False
      Width           =   195
   End
   Begin VB.Image img 
      ...
      Index           =   2
      Left            =   600
      Picture         =   "xpradiobutton.ctx":08E7
      Top             =   840
      Visible         =   0   'False
      Width           =   195
   End
   Begin VB.Image img 
      ...
      Index           =   1
      Left            =   360
      Picture         =   "xpradiobutton.ctx":0A41
      Top             =   840
      Visible         =   0   'False
      Width           =   195
   End
   Begin VB.Image img 
      ...
      Index           =   0
      Left            =   120
      Picture         =   "xpradiobutton.ctx":0BAB
      Top             =   840
      Visible         =   0   'False
      Width           =   195
   End
...
Rem Modified by CPUKiller (cpukiller@mail.ru) 11.06.03
...
Private Sub lbl_MouseMove(Button As Integer, Shift As Integer, x As Single, Y As Single)
    Call UserControl_MouseMove(Button, Shift, 15, 15)
End Sub
...
Private Sub UserControl_Resize()
    ...
    lbl.Top = (UserControl.Height - lbl.Height) \ 2 - 20
    lbl.Left = 250
End Sub

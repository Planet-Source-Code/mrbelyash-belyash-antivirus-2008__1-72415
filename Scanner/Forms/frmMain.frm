...
Begin VB.Form frmMain 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Label lblLastUpdate 
         ...
         Left            =   7830
         TabIndex        =   91
         ToolTipText     =   "Количество вирусных записей"
         Top             =   30
         Width           =   915
      End
   ...
   Begin VB.Frame frameScan 
      ...
      Begin Scaner.xpcmdbutton cmdScan 
         ...
         Left            =   1860
         TabIndex        =   56
         ToolTipText     =   "Запустить сканирование"
         Top             =   2700
         Width           =   1365
         _ExtentX        =   2408
         _ExtentY        =   609
      ...
      Begin Scaner.xpcmdbutton cmdStop 
         ...
         Left            =   3750
         TabIndex        =   57
         ToolTipText     =   "Остановить сканирование"
         Top             =   2700
         Width           =   1365
         _ExtentX        =   2408
         _ExtentY        =   609
      ...
      Begin VB.Label lblNormal 
         ...
         Left            =   5340
         TabIndex        =   101
         ToolTipText     =   "Не провереные файлы (файлы нулевой длинны)"
         Top             =   420
         Width           =   1635
      End
   ...
   Begin VB.Frame frameTool 
      ...
      Begin VB.Frame frameTool_EnableReg 
         ...
         Begin VB.CheckBox chkLMRegTool 
            BackColor       =   &H00E0E0E0&
            Caption         =   "Отключить доступ к реестру"
            Height          =   375
            Left            =   360
            TabIndex        =   113
            Top             =   3150
         ...
         Begin VB.CheckBox chkLMNoSR 
            BackColor       =   &H00E0E0E0&
            Caption         =   "Запретить восстановление системы"
            Height          =   375
            Left            =   360
            TabIndex        =   31
            Top             =   4005
         ...
         Begin VB.CheckBox chkLmLimitSR 
            BackColor       =   &H00E0E0E0&
            Caption         =   "Ограничит размер архива восстановления ОС"
            Height          =   375
            Left            =   360
            TabIndex        =   30
            Top             =   4545
         ...
         Begin VB.CheckBox chkLMNoSRConfig 
            BackColor       =   &H00E0E0E0&
            Caption         =   "Отключить доступ к настройкам восстановления ОС"
            Height          =   375
            Left            =   360
            TabIndex        =   28
            Top             =   4290
         ...
         Begin VB.CheckBox chkLMNoTaskmgr 
            BackColor       =   &H00E0E0E0&
            Caption         =   "Заблокировать Task Manager"
            Height          =   375
            Left            =   360
            TabIndex        =   27
            Top             =   3450
         ...
         Begin VB.CheckBox chkCUNoChangePwd 
            BackColor       =   &H00E0E0E0&
            Caption         =   "Запретить изменять проль пользователя"
            Height          =   375
            Left            =   360
            TabIndex        =   23
            Top             =   2355
         ...
         Begin VB.CheckBox chkCUNoLogoff 
            BackColor       =   &H00E0E0E0&
            Caption         =   "Запретить ""Смену пользователя"""
            Height          =   375
            Left            =   360
            TabIndex        =   20
            Top             =   1485
   ...
   Begin VB.Frame frameSetting 
      ...
      Begin Scaner.xpcmdbutton cmdConfigAppBlock 
         ...
         Left            =   4500
         TabIndex        =   69
         ToolTipText     =   "Редактировать настройки заблокированных приложений"
         Top             =   2910
         Visible         =   0   'False
         Width           =   1755
         _ExtentX        =   3096
      ...
      Begin Scaner.xpcmdbutton cmdRestoreDefault 
         ...
         Left            =   2910
         TabIndex        =   70
         ToolTipText     =   "Изменить настройки по умолчанию(рекомендуется)"
         Top             =   5070
         Width           =   1755
         _ExtentX        =   3096
         _ExtentY        =   661
      ...
      Begin Scaner.xpcmdbutton cmdSave 
         ...
         Left            =   5520
         TabIndex        =   80
         ToolTipText     =   "Сохранить настройки программы"
         Top             =   5580
         Width           =   1425
         _ExtentX        =   2514
         _ExtentY        =   661
      ...
      Begin Scaner.xpcheckbox xpcheckbox71 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "Сканировать все файлы"
         BackColor       =   14737632
      End
      Begin VB.Label Label2 
         BackColor       =   &H00E0E0E0&
         Caption         =   "Блокер приложений"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   13.5
            Charset         =   204
      ...
      Begin VB.Label lblLabel2 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "Ограничить размер проверяемого файла                                  байт"
         Height          =   195
         Left            =   420
         TabIndex        =   111
         Top             =   2550
      ...
      Begin VB.Label Label15 
         BackStyle       =   0  'Transparent
         Caption         =   "Частота обновления                    секунд"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   204
      ...
      Begin VB.Label Label13 
         BackColor       =   &H00E0E0E0&
         Caption         =   "Настройки проверки реестра"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   13.5
            Charset         =   204
...
wseDisk = ""
    ...
    Next
    If k = 0 Then
        Set X = Me.lvVirusFound.ListItems.Add(, , "Поиск autorun.inf", 1, 2)
         X.SubItems(1) = wseDisk
        X.SubItems(2) = "Диски очищены"
    Else
        Set X = Me.lvVirusFound.ListItems.Add(, , "Поиск autorun.inf", 1, 5)
        X.SubItems(1) = wseDisk
        X.SubItems(2) = "Ошибка при очистке"
    End If
    LogPrint "Autorun.inf на всех дисках удален."
    Set fso = Nothing
    Set drv = Nothing
    Set drvs = Nothing
    Set X = Nothing
...
Debug.Print frmMain.lvProcess.ListItems.Item(i).SubItems(1)
    If frmMain.lvProcess.ListItems.Item(i).SubItems(1) <> "System Process" Then
      ...
      End If
Next
'MsgBox "закончил сканить память"
Exit Sub
'мониторинг
...
If MsgBox("Для подгрузки новых баз программа должна быть перезапущена. Завершить работу с программой ?", vbCritical + vbYesNo, pr) = vbYes Then
    End
End If
...
mePt = Right(meobn, Len(meobn) - f)
    If Dir$(App.Path + "\" + mePt) = "" Then
        ...
        Exit Sub
    Else
        MsgBox "Данная база уже есть в каталоге", vbCritical
        Exit Sub
    End If
...
'запускаем online on-line обновлялку
   ModuleS.GoObnowl
End Sub
...
Dim a As String
    ...
    Me.txtPath.Text = a 'укажу путь
    cmdScan_CLBZ 'сканирую путь
End Sub
Sub Check_critical()
'проверить критические обьекты
'DoEvents
StopMycompScan = False
'GoTo 10
Call rescan_proc 'сканим активные процессы
 If StopMycompScan = True Then GoTo 803
    Dim FWinPath As String
    FWinPath = Environ("windir")
    'MsgBox FWinPath
    Me.txtPath.Text = FWinPath 'укажу путь
    cmdScan_CLBZ 'сканирую путь
 If StopMycompScan = True Then GoTo 803
10:
    Dim AUsr1 As String
    AUsr1 = Environ("ALLUSERSPROFILE") + "\"
    Me.txtPath.Text = AUsr1 'укажу путь
    cmdScan_CLBZ 'сканирую путь
 If StopMycompScan = True Then GoTo 803
    ...
    If hmD <> "" Then
         Me.txtPath.Text = hmD 'укажу путь
        cmdScan_CLBZ 'сканирую путь
    End If
 If StopMycompScan = True Then GoTo 803
Call get_IEtemp 'проверяем кеш эксплорера
803:
  StopMycompScan = True
Exit Sub
  
'GetAllRun'пока стартапы не буду обрабатывать
End Sub
Private Sub cmdSave_Click()
'сохранить настройки
If MsgBox("Сохранить настройки ?", vbYesNo + vbQuestion, pr) = vbNo Then
    Exit Sub
End If
If Len(txtSizeChk.Text) = 0 Or val(txtSizeChk.Text) = 0 Then
    MsgBox "Неправильный размер ограничения проверки файлов", vbCritical
Exit Sub
End If
...
GetAllRun
Dim X As ListItem
Set X = Me.lvVirusFound.ListItems.Add(, , "Проверка стартапов", 1, 2)
...
Exit Sub
100:
LogPrint "Ошибка при проверке стартапов-" + Error$
...
aryMode = Array(pr, "Внимание", "Внимание", pr, "Внимание")
strQuestion = "Вы действительно хотите выйти из программы ?"
...
If CLng(countZapOLD) = 0 Then
    ...
    MsgBox "Отсутствую базы.Работа дальше не имеет смысла", vbCritical
    End
...
'Call SetWindowPos(Me.hwnd, HWND_TOPMOST, 0, 0, 0, 0, FLAGS)
  ...
  Next
    ...
    'registry content
    Call LoadRegistry
   Me.SB.Caption = "Ожидание действий пользователя"
...
Call ShellExecute(0, "Open", "mailto:" + "mrbelyash@rambler.ru" + "?Subject=" + "Проблемы при работе с Belyash AntiTrojan", "", "", 1)
End Sub
...
Private Sub mnuClose_Click()
    If blnScan = True Then
        If MsgBox("Программа сканирует компьютер.Вы действительно хотите выйти ?", vbYesNoCancel, "Прервать сканирование") = vbYes Then
            Exit Sub
        End If
    End If
    cReg.StopSearch
...
'сканирование каталога или всего диска-Главная
   'check scan status
    On Error GoTo 115
    ...
    If blnScan = False Then 'not scanning
        ...
        Timer2.Enabled = True
        Me.SB.Caption = "Запущено сканирование..."
        Me.Picture1.Refresh
            Dim X As ListItem
            Set X = Me.lvVirusFound.ListItems.Add(, , "Начали в :", 1, 1)
            X.SubItems(1) = Time$
            'Set x = Nothing
           
            
If checkmemory = True Then
Set X = Me.lvVirusFound.ListItems.Add(, , "Проверка процессов", 1, 2)
        Call smdScaning2 'сканирую память
Else
    Set X = Me.lvVirusFound.ListItems.Add(, , "Проверка процессов запрещена ключём коммандной строки :", 1, 1)
End If
 If nostartUP = True Then
        Call mcheck_startap2 'сканирую стартап
Else
 Set X = Me.lvVirusFound.ListItems.Add(, , "Проверка стартапов запрещена ключём коммандной строки :", 1, 1)
End If
  If noAU = True Then
        Call autorans_killNow 'удаляю автораны
Else
    Set X = Me.lvVirusFound.ListItems.Add(, , "Проверка авторанов запрещена ключём коммандной строки :", 1, 1)
End If
   Set X = Me.lvVirusFound.ListItems.Add(, , "Проверка реестра", 1, 2)


Call modRegistry.CleanReg 'запустил чистку реестра
            Set X = Me.lvVirusFound.ListItems.Add(, , "Сканирую :", 1, 1)
        ...
        Me.txtPath.Text = Trim$(Me.txtPath.Text)
            ...
            Me.cmdStop.SetFocus
            ' strScanDetail = "<Font Name='Verdana' Size=3 Color=Blue>Scanning Начали в : " & Time$ & "<br>Сканирую : <i>" & Me.txtPath.Text & "</i><br>-----------------------------<br></font>"
            ...
            If blnScan = True Then
                ' strScanDetail = strScanDetail & "Scanning Завершено в :" & Time$ & "</font>"
                Set X = Me.lvVirusFound.ListItems.Add(, , "Закончили в :", 1, 1)
                X.SubItems(1) = Time$
                'tray message
               ' Call ShowTrayMessage("Belyash AntiTrojan 2008 beta", "Сканирование завершено" & vbCrLf & "Время сканирования: " & X1)
            Else
                ' strScanDetail = strScanDetail & "Scanning was Завершено в :" & Time$ & "</font>"
                Set X = Me.lvVirusFound.ListItems.Add(, , "Завершено в :", 1, 1)
                X.SubItems(1) = Time$
                'MsgBox "Сканирование прервано" & vbCrLf & "Время сканирования " & x1
                'tray message
               ' Call ShowTrayMessage("Belyash AntiTrojan 2008 beta", "Сканирование остановлено" & vbCrLf & "Время сканирования " & X1)
            End If
            Set X = Nothing
            ' Call UpdateDetail(strScanDetail, WebBrowser1)
    ...
    End If
    SB.Caption = "Сканирование завершено"
    Me.Picture1.Refresh
Exit Sub
115:
MsgBox "" + Error$
   ...
   'check scan status
    ...
    If blnScan = False Then 'not scanning
        ...
        'Call rescan_proc '1
         ...
         LogPrint "Scan-" + Trim$(Me.txtPath.Text)
        Me.txtPath.Text = Trim$(Me.txtPath.Text)
        SB.Caption = "Начали сканирование"
            lvVirusFound.ListItems.Clear
            Dim ST As Variant, ET As Variant
            'get start time
            ST = Time
            ...
            Else
                ...
                'MsgBox "Сканирование прервано" & vbCrLf & "Время сканирования " & x1
                'tray message
                'Call ShowTrayMessage("Belyash AntiTrojan 2008 beta", "Сканирование прервано" & vbCrLf & "Время сканирования " & X1)
            End If
            Set X = Nothing
            ' Call UpdateDetail(strScanDetail, WebBrowser1)
...
'сканирование каталога или всего диска-Главная
   'check scan status
    ...
    If blnScan = False Then 'not scanning
        ...
        Me.txtPath.Text = Trim$(Me.txtPath.Text)
        SB.Caption = "Начали сканирование"
            'lvVirusFound.ListItems.Clear'зачистка панели
            Dim ST As Variant, ET As Variant
            'get start time
            ST = Time
            'reset all statistic
...
Private Sub cmdStop_Click()
    If blnScan = True Then
        If MsgBox("Остановить сканирование ?", vbYesNo + vbDefaultButton2 + vbExclamation, "Внимание") = vbYes Then
         '  Me.mnuenblsc.Caption = "Сканировать Мой компьютер"
            ...
            blnScan = False
                Me.txtPath.Text = ""
            SB.Caption = "Прервано пользователем"
             If cmdScan.Enabled = False Then
                cmdScan.Enabled = True
            End If
        End If
    End If
     StopMycompScan = False
     blnScan = False
    SB.Caption = "Проверка прервана пользователем..."
End Sub
...
Private Sub Form_Unload(Cancel As Integer)
        'check scanning
    If blnScan = True Then
        If MsgBox("Производится сканирование. Вы действительно хотите выйти ?", vbYesNoCancel + vbExclamation, "Прервать сканирование?") = vbYes Then
            cReg.StopSearch
            cmdStop_Click
            End
        Else
...
Slider1.ToolTipText = "Низкий"
Case "1"
Slider1.ToolTipText = "Нормальный"
Case "2"
Slider1.ToolTipText = "Высокий"
Case "3"
Slider1.ToolTipText = "Максимальный"
...
End Sub
Sub backupRegnow()
 If MsgBox("Сделать backup реестра?", vbYesNo + vbQuestion) = vbYes Then
    SB.Caption = "Делаю копию реестра...Подождите"
        create_Backup "1"
         create_Backup "2"
          create_Backup "3"
           create_Backup "4"
            create_Backup "5"
    SB.Caption = "Копия реестра создана"
    End If
End Sub
 Sub ExecCmd(cmdline$)
...
Exit Sub
100:
MsgBox "BACKUP не создан" + vbCrLf + Error$, vbCritical + vbApplicationModal
...
Private Sub cmdStartStop_Click()
    ...
    'button CAPTION
    If cmdStartStop.Caption = "Старт" Then 'start => stop
        cmdStartStop.Caption = "Стоп"
    Else
        cmdStartStop.Caption = "Старт"     'stop => start
        cReg.StopSearch
        txtCurKey.Text = ""
        Exit Sub
    End If
    ...
    txtCurKey.Text = ""
    lblScanRegStatus.Caption = "Проверяю :"
...
'Call backupRegnow 'create backup
    ...
    'change last status
    txtCurKey.Text = "Чистка реестра завершена"
...
Private Sub cReg_SearchFinished(ByVal lReason As Long)
    ...
    If lReason = 0 Then
        Me.lblScanRegStatus.Caption = "Проверка завершена"
    ElseIf lReason = 1 Then
        Me.lblScanRegStatus.Caption = "Проверка прервана"
    Else
        Me.lblScanRegStatus.Caption = "Ошибка проверки"
    End If
...
If Check1.Value = vbChecked Then
    SB.Caption = "Обрабатываю переменные окружения...Ждите..."
    peremen
    n = n + 1
End If

If Check3.Value = vbChecked Then
    SB.Caption = "Обрабатываю BHO"
   check_BHO
    n = n + 1
End If
...
If Check4.Value = vbChecked Then
    SB.Caption = "Обрабатываю активные окна...Ждите..."
    ModuleA.Ac_Wind
    n = n + 1
End If
If Check2.Value = vbChecked Then
    SB.Caption = "Обрабатываю активные процессы...Ждите..."
    poci12
    n = n + 1
End If
If Check5.Value = vbChecked Then
    'экспорт регистра
    SB.Caption = "Обрабатываю реестр ...Ждите..."
        create_Backup "1"
         create_Backup "2"
          create_Backup "3"
           create_Backup "4"
...
If Check7.Value = vbChecked Then
     SB.Caption = "Считываю настройки ...Ждите..."
    GetAllKeys1
    n = n + 1
End If

If Check6.Value = vbChecked Then
     SB.Caption = "Обрабатываю автозагрузку ...Ждите..."
    startup_log
    n = n + 1
End If
If n > 0 Then
    GoTo 9
Else
    SB.Caption = "Лог не создан.Выберите опции"
    GoTo 800
...
Close #1
     SB.Caption = "Лог создан и сохранен в файле analize.log"
     MsgBox "Данные сохранены в файле" + vbCrLf + App.Path + "\analize.log", vbInformation
     Exit Sub
800:

    MsgBox "Лог не создан" + vbCrLf + Error$, vbCritical, pr
    Debug.Print Err
End Sub
...
Exit Sub
100:
MsgBox "Репорт не создан" + vbCrLf + Error$, vbCritical
End Sub
...
analize "Время работы " & Str(a_hour) & " час(а)ов " & Str(a_minute) & " минут" & Str(a_second) & " секунд"
analize "-------------Info start----------------"
End Sub
...
Sub loadCapt()
imgScan.Caption = "Сканирование"
imgSetting.Caption = "Настройки"
imgTools.Caption = "Инструменты"
Image7.Caption = "Анализ"
imgLicense.Caption = "Лицензия"
imgAbout.Caption = "Помощь"
cmdCleanReg.Caption = "По умолчанию"
cmdClearAutorun.Caption = "Удалить автораны"
cmdScanInvalidReg.Caption = "Исправить реестр"
cmdTool_ProcessMan.Caption = "Процессы"
cmdTool_Startup.Caption = "Автозагрузка"
cmdEnableReg.Caption = "Реестр"
cmdProcessRefresh.Caption = "Обновить"
cmdProcessEnd.Caption = "Завершить"
cmdStartStop.Caption = "Старт"
cmdDeleteInvalidKey.Caption = "Удалить"
cmdStartUp_Del.Caption = "Удалить"

xpcheckbox71.Caption = "Сканировать все файлы"
mnuQarantine.Caption = "Перемещать в карантин"
chkLog.Caption = "Ограничить отчет"
chkAutoScan.Caption = "Исправлять реестр"
xpcheAutoran.Caption = "Зачистка авторанов"
chkBlockRisk.Caption = "Блокировать подозрительные"
chkAutoRefeshProList.Caption = "Автообновление процессов"
chkExeBlock.Caption = "Включить блокиратор приложений"
chkControlAll.Caption = "Контролировать запуск всех программ"
optScanAll.Caption = "Все"
optScanExt.Caption = "Указаные расширения"
cmdRestoreDefault.Caption = "По умолчанию"
cmdSave.Caption = "Сохранить"
Command1.Caption = "Сохранить"
Check1.Caption = "Переменные окружения"
Check2.Caption = "Активные процессы"
Check3.Caption = "Надстройки IE"
Check4.Caption = "Активные окна"
Check5.Caption = "Экспортировать реестр"
Check6.Caption = "Автозагрузка"
Check7.Caption = "Настройки"
cmdScan.Caption = "Старт"
cmdStop.Caption = "Стоп"
lblLabel2.Caption = "Ограничить размер проверяемого файла                                  байт"
End Sub
...
If Not IsNumeric(txtSizeChk) Then MsgBox "Вводите только числа", vbCritical
End Sub

...
Private Process() As PROCESSENTRY32
...
On Error GoTo VB_Error
    ...
    If Heap32ListFirst(hSnapShot, HEAPLIST32) = False Then
        ...
        If CloseHandle(hSnapShot) = False Then
        'Call Err_Dll(Err.LastDllError, "CloseHandle failed", sLocation, "Heap32List_Enum")
        Exit Function
    Else
...
Public Sub List_ActiveProcess(TreeView As TreeView)
    '// Same
...
Public Sub List_ActiveModules(TreeView As TreeView)

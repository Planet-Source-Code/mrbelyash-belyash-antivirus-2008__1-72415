...
Public Sub CleanReg()
   ...
   Dim z1 As String
    ...
    If z1 <> "0" Then
        Set X = frmMain.lvVirusFound.ListItems.Add(, , "DisableRegistryTools(подозрение на действие трояна)", 1, 5)
        X.SubItems(1) = "HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Policies\System"
        X.SubItems(2) = "Исправлено"
        Set X = Nothing
        CreateDwordValue HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System", "DisableRegistryTools", 0
        'LogPrint "Исправлена ветка-HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Policies\System\DisableRegistryTools"
    End If
    ...
    If z2 <> "0" Then
        ...
        Set X = Nothing
         CreateDwordValue HKEY_LOCAL_MACHINE, "SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System", "DisableRegistryTools", 0
         LogPrint "Исправлена ветка-HKEY_LOCAL_MACHINE\Software\Microsoft\Windows\CurrentVersion\Policies\System\DisableRegistryTools"
    End If
    Dim z3 As String
    z3 = val(getstring(GetClassKey("HKEY_CURRENT_USER"), "Software\Microsoft\Windows\CurrentVersion\Policies\System", "DisableRegedit"))
    If z3 <> "0" Then
        Set X = frmMain.lvVirusFound.ListItems.Add(, , "DisableRegedit(подозрение на действие трояна)", 1, 5)
        X.SubItems(1) = "HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Policies\System"
        X.SubItems(2) = "Исправлено"
        Set X = Nothing
                    CreateDwordValue HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System", "DisableRegedit", 0
            LogPrint "Исправлена ветка-HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System\DisableRegedit"
    End If
    
    Dim z4 As String
    z4 = val(getstring(GetClassKey("HKEY_CURRENT_USER"), "Software\Microsoft\Windows\CurrentVersion\Policies\System", "DisableTaskMgr"))
    If z4 <> "0" Then
        Set X = frmMain.lvVirusFound.ListItems.Add(, , "DisableTaskMgr(подозрение на действие трояна)", 1, 5)
        X.SubItems(1) = "HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Policies\System"
        X.SubItems(2) = "Исправлено"
        Set X = Nothing
        CreateDwordValue HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System", "DisableTaskMgr", 0
        LogPrint "Исправлена ветка-HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System\DisableTaskMgr"
    End If
    ...
    If z5 <> "0" Then
        ...
        LogPrint "Исправлена ветка-HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System\DisableTaskMgr"
    End If
    Dim z6 As String
    z6 = val(getstring(GetClassKey("HKEY_CURRENT_USER"), "Software\Microsoft\Windows\CurrentVersion\Policies\System", "DisableCMD"))
    If z6 <> "0" Then
        Set X = frmMain.lvVirusFound.ListItems.Add(, , "DisableCMD(подозрение на действие трояна)", 1, 5)
        X.SubItems(1) = "HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Policies\System"
        X.SubItems(2) = "Исправлено"
        Set X = Nothing
        CreateDwordValue HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System", "DisableCMD", 0
        LogPrint "Исправлена ветка-HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System\DisableCMD"
    End If
    ...
    If z7 <> "0" Then
        Set X = frmMain.lvVirusFound.ListItems.Add(, , "RestrictRun(подозрение на действие трояна)", 1, 5)
        ...
        LogPrint "Исправлена ветка-HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Policies\Explorer\RestrictRun"
    End If
    ...
    If z9 <> "0" Then
        Set X = frmMain.lvVirusFound.ListItems.Add(, , "DisableConfig(подозрение на наличие трояна)", 1, 5)
        ...
        LogPrint "Исправлена ветка-HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows NT\SystemRestore\DisableConfig"
    End If
    ...
    If z10 <> "0" Then
        Set X = frmMain.lvVirusFound.ListItems.Add(, , "DisableMSI(подозрение на действия трояна)", 1, 5)
        ...
        Set X = Nothing
         ...
         LogPrint "Исправлена ветка-HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\Installer\DisableMSI"
    End If

...
Me.Label2.Caption = "Приложение " + Spliting(Me.Label3.Caption, "\") + " пытается выйти в сеть. Разрешить?"
xpcmdpicture1.Caption = "Разрешить"
xpcmdpicture2.Caption = "Заблокировать"
End Sub
...
'Me.Label2.Caption = "Приложение " + newAplic + " пытается выйти в сеть. Разрешить?"

...
Begin VB.Form frmAbout 
   ...
   Begin ComctlLib.ListView ListView1 
      ...
      BeginProperty ColumnHeader(2) {0713E8C7-850A-101B-AFC0-4210102A8DA7} 
         ...
         Key             =   ""
         Object.Tag             =   ""
         Text            =   "Инфо/Кол-во записей в базе"
         Object.Width           =   2705
      EndProperty
...
On Error GoTo 100
Call ShellExecute(0, "Open", "mailto:" + "mrbelyash@rambler.ru" + "?Subject=" + "Проблемы при работе с Belyash Shield", "", "", 1)
Exit Sub
100:
End Sub
...
Dim X As ListItem
Set X = Me.ListView1.ListItems.Add(, , "Всего записей")
...
On Error GoTo 100
Call ShellExecute(0, "Open", "mailto:" + "mrbelyash@yandex.ru" + "?Subject=" + "Проблемы при работе с Belyash Shield", "", "", 1)
Exit Sub
100:
End Sub
